...
class NewsCategories extends Model
{
    ...
    protected $table = 'indikator_content_news_categories';

    public $rules = [
        'name'   => 'required',
        'slug'   => ['required', 'regex:/^[a-z0-9\/\:_\-\*\[\]\+\?\|]*$/i', 'unique:indikator_content_news_categories'],
    ...
    {
        Db::table('indikator_content_news_relations')->where('news_categories_id', $this->id)->delete();
    }
    ...
    protected static function getCategoryPageUrl($pageCode, $category, $theme)
    {
        ...
        $properties = $page->getComponentProperties('newsList');
