...
class PortfolioCategories extends Model
{
    ...
    protected $table = 'indikator_content_portfolio_categories';

    public $rules = [
        'name'   => 'required',
        'slug'   => ['required', 'regex:/^[a-z0-9\/\:_\-\*\[\]\+\?\|]*$/i', 'unique:indikator_content_portfolio_categories'],
    ...
    {
        Db::table('indikator_content_portfolio_relations')->where('portfolio_categories_id', $this->id)->delete();
    }
