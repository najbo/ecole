...
use Indikator\Content\Models\Portfolio as ItemPost;
use Indikator\Content\Models\PortfolioCategories as ItemCategory;
use Lang;
use Redirect;
...
class PortfolioList extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'indikator.content::lang.components.portfolio_list_name',
            'description' => ''
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            ...
            'noPostsMessage' => [
                ...
                'type'              => 'string',
                'default'           => Lang::get('indikator.content::lang.components.portfolio_no_items'),
            ...
            'sortOrder' => [
                ...
                'options' => [
                    ...
                    'sort_order asc'    => Lang::get('indikator.content::lang.sorting.manual_asc'),
                    'sort_order desc'   => Lang::get('indikator.content::lang.sorting.manual_desc'),
